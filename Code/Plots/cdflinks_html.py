...
# Load the dataset
df = pd.read_csv("../../docs/enriched_as_links_june.csv")
...
# Save as HTML
fig.write_html("interactive_cdf_co2_intensity_june.html")
print("Saved: interactive_cdf_co2_intensity_june.html")
