...
# Load data
df = pd.read_csv("../../docs/enriched_as_links_july.csv")
...
# Save as HTML
fig.write_html("interactive_heatmap_top10_orgs_with_x_july.html")
print("Saved: interactive_heatmap_top10_orgs_with_x_july.html")
