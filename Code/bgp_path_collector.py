#This script collects BGP RIB (Routing Information Base) snapshots for a given date, filters them to remove invalid/bogus prefixes and AS paths, and writes the clean results to a CSV #file.
