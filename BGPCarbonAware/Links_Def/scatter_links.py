...
ax = sns.heatmap(
    ...
    linecolor="gray",
    square=True,
    cbar_kws={'label': 'Total CO₂ (gCO₂)', 'format': '%.0f'},
    mask=pivot.isnull(),
    annot=False
)
...
plt.title("CO₂ Emissions Between Top 20 Organizations", fontsize=18, pad=20)
plt.xlabel("Destination Organization", fontsize=14, labelpad=10)
plt.ylabel("Source Organization", fontsize=14, labelpad=10)
...
cbar.set_label('Total CO₂ (gCO₂)', fontsize=12)
